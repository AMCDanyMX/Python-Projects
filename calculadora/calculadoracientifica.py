...
ventana=Tk()
ventana.title("Calculadora IS-UAZ")
ventana.geometry("840x500")
ventana.configure(background="black")
color_boton=("white")

#definicion de los botones para que al momento de presionar un boton ejecute
#en la pantalla
def btnClik(num):
    global operador
    operador=operador+str(num)
    display.set(operador) #ESTA PARTE SIRVE PARA VISUALIZAR LA OPERACION EN LA PANTALLA
def clear():
    global operador
    operador=("")
...
def operacion():
    ...
    try:
        ...
        clear()
        opera=("ERROR")
    display.set(opera)#MUESTRA EL RESULTADO
#Establecer las medidas para todos los botones
ancho_boton=5
alto_boton=2
#creacion del display principal
display=StringVar()
#configuracion del display principal
...
#botones de convertidores de temperatura
...
#Botones del 0 al 9 y signos aritmeticos
...
#botones de signos de operaciones
...
#etiqueta para decir que los datos deben ser ingresados por teclado
